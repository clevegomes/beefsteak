...
//      echo $e->getMessage();
    ...
    private function getSubmittedField() {
    ...
    public function validate() {
        ...
        if ($this->formBuild == Builder::FORM_SELFSTANDING && $this->validateToken()) {
            $this->messagesManager(new Message(__('Token has expired. You need to reload the form.', 'hydraforms'), 'danger'));
        }
    ...
    public function render() {
        ...
        if ($this->formBuild == Builder::FORM_SELFSTANDING) {
            print '<form action="' . $this->submit . '" method="post" name="' . $this->getName() . '" ' . $this->printAttributes() . '>';
        }
    ...
    public function customRender($preserveFields = FALSE) {
        ...
        // @todo - refactor
        if ($this->formBuild == Builder::FORM_SELFSTANDING) {
            $output['form_start'] = '<form action="' . $this->submit . '" method="post" name="' . $this->getName() . '" ' . $this->printAttributes() . '>';
        }
