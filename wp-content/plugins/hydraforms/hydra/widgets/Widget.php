...
class WidgetManager {
     ...
     * @return array|mixed
     */
    public function getWidgetForm($name, $fieldDefinition, $fieldRecord, $parentElement, $noWrapper = FALSE) {
        $widget = $this->getWidget($name, array($fieldDefinition, $fieldRecord, $parentElement));
        if(!$widget) {
            return;
        }
        if ($noWrapper) {
     ...
     * @param bool $noWrapper
     */
    public function getWidgetAdminForm($name, $fieldDefinition, $fieldRecord, $parentElement, $noWrapper = FALSE) {
        $widget = $this->getWidget($name, array($fieldDefinition, $fieldRecord, $parentElement));
        if(!$widget) {
            return;
        }
     ...
     * @param bool $noWrapper
     */
    public function getWidgetAdminFilterForm($name, $fieldDefinition, $fieldRecord, $parentElement, $noWrapper = FALSE) {
        $widget = $this->getWidget($name, array($fieldDefinition, $fieldRecord, $parentElement));
        if(!$widget) {
            return;
        }
